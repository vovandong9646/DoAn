  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-lg-12 top">
        <h3 class="pull-left">{!! $product->trademark->category->name !!} : {!! $product->trademark->name !!}</h3>
        <ol class="breadcrumb pull-right">
          <li><a href="{{url('/')}}">Home</a></li>
          <li><a href="{{route('trademarks',$product->trademark->id)}}">{!! $product->trademark->name !!}</a></li>
